...
$cat = $row_edit['product_subcat'];

$m_id = $row_edit['supplier_name'];
...
$p_price = $row_edit['product_bprice'];

$p_desc = $row_edit['product_desc'];

$p_keywords = $row_edit['product_keywords'];

$psp_price = $row_edit['product_sellprice'];
...
$get_supplier = "select * from suppliers where supplier_id='$m_id'";

$query_supplier = mysqli_query($con,$get_supplier);

$row_sup = mysqli_fetch_array($query_supplier);
